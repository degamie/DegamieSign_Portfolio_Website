// WID(24/6/2026)//(Sarthak Mittal)#(NavBar).1,1.1
...
export default function NavBar(){
    getnavbarId=(navbarid)=>{return navbarid;}//Fethcing NavBarId in Game Portfolio
    setnavbarName=(navbarname)=>{this.navbarname=navbarname;}//binding NavBar name in App
