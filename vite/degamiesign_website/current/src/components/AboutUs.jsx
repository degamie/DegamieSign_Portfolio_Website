//WID(23/1/2026)//Sarthak Mittal(Degamiesign)#1.1.1
import React from 'react'
AuthorName=null;innerWidth=0;AuthPhoneNum=0;innerHeight=0;outerWidth=0;innerWidth=0;AuthorId=0;outerHeight=0;//initialzing Variables
function AboutUs() {
